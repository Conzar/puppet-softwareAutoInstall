...
# Softwareautoinstall Puppet Module Developments
...
### Directory Layout
       ...
       softwareAutoInstall/       # Main directory 
           ...
           `-- manifests/
                ...
                `-- classes/     # Hold manifest for softwareAutoInstall classes/
                     `-- softwareAutoInstall.pp         # defines the softwareAutoInstall class
                     `-- softwareAutoInstall-params.pp  # softwareAutoInstall module variables 
                `-- definitions/ # Hold manifest for softwareAutoInstall definitions
                     `-- softwareAutoInstall-mydef.pp   # defines the softwareAutoInstall::mydef definition   `-- templates/        # Module ERB template files
